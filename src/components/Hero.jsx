            ...
            <section className="hero bg-cover bg-center h-80 " style={{ backgroundImage: `url(${heroImage})` }}>
                <div className="flex items-center justify-center h-full bg-green-600/60">
                    <div className="text-center text-white flex flex-col items-center">
                        ...
                        <p className="w-full px-4 md:w-3xl mt-4 text-lg md:text-xl">Discover local businesses and hidden gems in Woodridge – your go-to kiosk for connecting with the best shops, services, and more!</p>
