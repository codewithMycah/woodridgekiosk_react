...
// icons
import { MapPin, Phone, Link as LinkIcon, ArrowUpAZ } from 'lucide-react'
    ...
    return (
        ...
        <div className='flex flex-col p-6 mx-auto'>
            <div className='flex flex-row gap-x-4 items-center justify-center text-sm text-gray-600'>
                ...
                <div>
                    {/* Sort Button */}
                    <button className='flex flex-row items-center justify-center gap-2 px-4 py-1 rounded-lg border-2 border-gray-300' onClick={btnSort}>
                        <ArrowUpAZ /> Sort
                    </button>
                </div>
            </div>
